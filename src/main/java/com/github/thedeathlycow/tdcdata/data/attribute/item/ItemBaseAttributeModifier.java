...
public class ItemBaseAttributeModifier {
    private final Item item;
    private final EquipmentSlot slot;
    private final List<AttributeHolder> attributeModifiers;


    public ItemBaseAttributeModifier(
            Item item,
            EquipmentSlot slot,
    ...
    public static class Serializer implements JsonDeserializer<ItemBaseAttributeModifier> {

        public static final Gson GSON = new GsonBuilder()
                .registerTypeAdapter(ItemBaseAttributeModifier.class, new Serializer())
                .create();

        @Override
        public ItemBaseAttributeModifier deserialize(JsonElement jsonElement, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
            ...
            return new ItemBaseAttributeModifier(item, slot, attributeModifiers);
        }
    }
}
