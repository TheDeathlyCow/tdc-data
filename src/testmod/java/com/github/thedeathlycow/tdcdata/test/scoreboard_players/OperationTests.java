...
public class OperationTests {
    ...
    @GameTest(templateName = "tdcdata-test:scoreboard.players.operation.exponent")
    ...
    @GameTest(templateName = "tdcdata-test:scoreboard.players.operation.logb")
    public void logBaseGeneratesCorrectValue(TestContext context) {
        context.pushButton(BUTTON_POS);
        context.expectBlockAtEnd(Blocks.LIME_WOOL, BUTTON_POS);
    }

    @GameTest(templateName = "tdcdata-test:scoreboard.players.operation.logb.zero")
    public void logBaseNegativeDoesNotChangeInput(TestContext context) {
        context.pushButton(BUTTON_POS);
        context.expectBlockAtEnd(Blocks.LIME_WOOL, BUTTON_POS);
    }

    @GameTest(templateName = "tdcdata-test:scoreboard.players.operation.logb.negative")
    public void logBaseZeroDoesNotChangeInput(TestContext context) {
        context.pushButton(BUTTON_POS);
        context.expectBlockAtEnd(Blocks.LIME_WOOL, BUTTON_POS);
    }

    @GameTest(templateName = "tdcdata-test:scoreboard.players.operation.rshift")
    public void rShiftGeneratesCorrectValue(TestContext context) {
        context.pushButton(BUTTON_POS);
        context.expectBlockAtEnd(Blocks.LIME_WOOL, BUTTON_POS);
    }

    @GameTest(templateName = "tdcdata-test:scoreboard.players.operation.rshift.negative")
    public void rShiftNegativeGeneratesCorrectValue(TestContext context) {
        context.pushButton(BUTTON_POS);
        context.expectBlockAtEnd(Blocks.LIME_WOOL, BUTTON_POS);
    }

    @GameTest(templateName = "tdcdata-test:scoreboard.players.operation.u_rshift.negative")
